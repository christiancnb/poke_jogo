...
public class PokemonTest {
    ...
    void danoSemVantagemDeTipo() {
        Pokemon a = new Braseiro("A", 50, 20, 10);
        Pokemon b = new Braseiro("B", 50, 20, 10); // fogo vs fogo = neutro (1.0x)
    ...
    void danoComVantagemDeTipo() {
        Pokemon fogo = new Braseiro("Fogo", 50, 20, 10);
        Pokemon planta = new Folharal("Planta", 50, 20, 20); // vida cheia: nao aciona o bonus especial do fogo
    ...
    void danoComDesvantagemDeTipo() {
        Pokemon planta = new Folharal("Planta", 50, 20, 10);
        Pokemon fogo = new Braseiro("Fogo", 50, 20, 20);
    ...
    void danoNuncaFicaAbaixoDeUm() {
        Pokemon fraca = new Marulho("Fraca", 30, 1, 5);
        Pokemon tanque = new Braseiro("Tanque", 100, 5, 100);
    ...
    void criaturaMorreQuandoVidaChegaAZero() {
        Pokemon c = new Marulho("Teste", 20, 10, 5);
    ...
    void vidaNuncaUltrapassaOMaximoAoCurar() {
        Pokemon c = new Folharal("Teste", 50, 10, 5);
    ...
    void braseiroCausaBonusContraAlvoEnfraquecido() {
        Pokemon braseiro = new Braseiro("Braseiro", 50, 20, 0);
        Pokemon alvoFraco = new Folharal("AlvoFraco", 100, 10, 0);
        alvoFraco.receberDano(80); // vida: 20/100 = 20%, abaixo de 30%
        Pokemon alvoCheio = new Folharal("AlvoCheio", 100, 10, 0);
    ...
    void folharalCuraAoAtacar() {
        Pokemon folharal = new Folharal("Folharal", 50, 15, 5);
        folharal.receberDano(20); // vida: 30/50
        Pokemon alvo = new Marulho("Alvo", 50, 5, 5);
