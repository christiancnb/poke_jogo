...
public class CapturaTest {
    ...
    void chanceEhMaiorQuandoAlvoEstaComPoucaVida() {
        Pokemon vidaCheia = new Marulho("A", 50, 10, 5);
        Pokemon vidaBaixa = new Marulho("B", 50, 10, 5);
    ...
    void chanceNuncaFicaAbaixoDoMinimo() {
        Pokemon vidaCheia = new Marulho("Cheia", 50, 10, 5);
    ...
    void chanceNuncaUltrapassaOMaximo() {
        Pokemon quaseMorta = new Marulho("QuaseMorta", 100, 10, 5);
